...
\titulo{Título da Monografia:Avaliação de diversas APIs de gecodificação} 
\subtitulo{subtítulo}
\autor{Ana Luiza Almeida Soares} \autorcite{Aluno, Nome}
\local{Ouro Preto} \uf{MG}
\data{XX de mês de Ano} \ano{2023}
\orientador{Rodrigo Cesar Pedrosa Silva}  % Nome do orientador. Caso seja uma orientadora use o comando ∖orientador[Orientadora:]{Nome}
...
\include{PreTextuais/Resumo} % (Abstract no mesmo arquivo)
...
\include{Capitulos/Cap3-Desenvolvimento}
\include{Capitulos/Cap4-Resultados}
