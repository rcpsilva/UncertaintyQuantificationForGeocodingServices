...
Para melhor vizualização, decidimos então retirar os outliers de todas os boxplots. 

As figuras \ref{fig:boxplot-api-mapbox-semout-bh} e \ref{fig:boxplot-api-mapbox-semout-sp} mostram os boxplots do erro da Mapbox para os dados de Belo Horizonte e São Paulo respectivamente.
